...
<body>
    ...
    <script>
        ...
        const googleHybrid = L.tileLayer('https://mt1.google.com/vt/lyrs=s&x={x}&y={y}&z={z}', {
            maxZoom: 21,
        ...
        const markers = L.layerGroup(
            markerData.map(({ coords, popup }) => L.marker(coords, { icon: station }).bindPopup(popup))
        ).addTo(map);
                ...
                geojsonLayer = L.geoJSON(data, {
                    ...
                    onEachFeature: (feature, layer) => {
                        layer.on('click', () => {
                            ...
                            layer.setStyle({ weight: 3, fillOpacity: 1, fillColor: '#FFFF00' });
